...
def test_flat_dict_source_basic():
    data = {"APP_HOST": "localhost", "APP_PORT": 8080, "APP_DEBUG": True, "APP_SCORE": 99.9, "IGNORED_LIST": [1, 2]}
...
def test_flat_dict_source_case_insensitive():
    data = {"app_host": "localhost", "APP_PORT": 8080}
...
def test_file_source_traversal_and_types(tmp_path):
    data = {"section": {"key": 123, "deep": {"val": True}}, "list_val": [1, 2, 3]}
